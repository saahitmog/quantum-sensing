...
class ESRMeasure(Measurement):
    ...
    def setup(self):
        ...
        self.settings.New('Start_Frequency', dtype=float, initial=3.088, spinbox_decimals=4, unit='GHz', spinbox_step=0.001)
        self.settings.New('End_Frequency', dtype=float, initial=3.11, spinbox_decimals=4, unit='GHz', spinbox_step=0.001)      
        self.settings.New('Vpp', dtype=float, initial=0.2, spinbox_decimals=3, spinbox_step=0.001, unit='V')
        self.settings.New('N_pts', dtype=int, initial=11)
        ...
        self.settings.New('magnet_power', dtype=float, initial=0.6)
        self.settings.New('Navg', dtype=int, initial=1)
    ...
    def run(self):
        ...
        if(self.settings.plotting_type != 'signal'):
            self.plot = self.graph_layout.addPlot(title="Contrast vs Frequency")
