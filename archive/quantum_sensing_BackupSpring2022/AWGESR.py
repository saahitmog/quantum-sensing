...
def runExperiment():
    try:
        ...
        # for x in range(1, 100):
            #     instrumentCalls(inst, sinePulse(4999936, 8, 1, 10, 1, 1), self.settings.Vpp.value)
            #     time.sleep(10)

        for x in range(10):
            print('square wave')
            instrumentCalls(inst, scaleWaveform(squareWave(4999936), "P9082M"))
            time.sleep(10)
