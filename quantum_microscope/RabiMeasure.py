...
class RabiMeasure(Measurement):
    ...
    def setup(self):
        ...
        self.settings.New('Start_Duration', dtype=int, initial=100, unit='ns')
        self.settings.New('End_Duration', dtype=int, initial=200, unit='ns')      
        ...
        self.settings.New('MW_delay', dtype=int, initial=100, unit='us')
            ...
            for j in range(self.settings.Navg.value):
                ...
                for step in range(0, len(sweep)):
                    ...
                    if(mode == 'AWG'):
                        ...
                        AWGctl.makeSingleRabiSeq(inst, f, self.settings.MW_delay.value, self.settings.MW_Frequency.value, self.settings.Vpp.value)
                    else:    
