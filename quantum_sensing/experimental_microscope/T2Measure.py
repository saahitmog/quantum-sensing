...
class T2Measure(Measurement):
    ...
    def setup(self):
        ...
        self.settings.New('Start_Tau', dtype=float, initial=5e-7, spinbox_decimals=3, unit='s', si=True)
        self.settings.New('End_Tau', dtype=float, initial=1e-4, spinbox_decimals=3, unit='s', si=True)      
