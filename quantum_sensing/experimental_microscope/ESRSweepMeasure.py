...
class ESRSweepMeasure(Measurement):
    ...
    def setup(self):
        ...
        self.settings.New('Start_Frequency', dtype=float, initial=3.6, spinbox_decimals=4, unit='GHz', spinbox_step=0.001)
        self.settings.New('End_Frequency', dtype=float, initial=3.66, spinbox_decimals=4, unit='GHz', spinbox_step=0.001)      
