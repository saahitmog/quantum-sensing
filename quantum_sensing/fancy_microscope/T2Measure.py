            ...
            for j in range(self.settings.Navg.value):
                ...
                for step in range(0, len(sweep)):
                    ...
                    if(mode == 'AWG'):
                        ...
                        AWGctl.makeT2Seq(inst, f, self.settings.t_AOM.value, self.settings.t_readoutDelay.value, self.settings.t_pi.value, self.settings.MW_Frequency.value, self.settings.Vpp.value)
                    else:    
